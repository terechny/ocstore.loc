...
class ModelExtensionAdvertiseGoogle extends Model {
    ...
    public function deleteEvents() {
        ...
        $this->model_extension_event->deleteEvent('advertise_google');
    }
    ...
    public function createEvents() {
        ...
        foreach ($this->events as $trigger => $actions) {
            foreach ($actions as $action) {
                $this->model_extension_event->addEvent('advertise_google', $trigger, $action, 1);
            }
        }
    }
