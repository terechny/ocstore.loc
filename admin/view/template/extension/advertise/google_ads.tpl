  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="form-group">
        <label class="control-label" for="input-name"><?php echo $text_product_name; ?></label> <input type="text" name="filter_name" value="" placeholder="<?php echo $text_product_name; ?>" id="input-name" class="form-control" autocomplete="off">
      </div>
      <div class="form-group">
        <label class="control-label" for="input-model"><?php echo $text_product_model; ?></label> <input type="text" name="filter_model" value="" placeholder="<?php echo $text_product_model; ?>" id="input-model" class="form-control" autocomplete="off">
      </div>
      <div class="form-group">
        <label class="control-label" for="input-category"><?php echo $text_product_category; ?></label>
        <div class="category-select-container">
          <input id="input-category" type="text" name="category_autocomplete" value="" class="form-control" placeholder="<?php echo $text_product_category; ?>"/> <input type="hidden" name="filter_category_id" value="">
          <button id="button-category-remove" class="btn btn-default" disabled><i class="fa fa-close"></i></button>
        </div>
      </div>
      <div class="form-group">
        <label class="control-label" for="select-is-modified"><?php echo $text_product_is_modified; ?></label> <select class="form-control" name="filter_is_modified" id="select-is-modified">
      ...
      <div class="form-group text-right">
        <button type="button" id="button-filter" class="btn btn-default"><i class="fa fa-filter"></i> <?php echo $text_filter; ?></button>
      </div>
    </div>
  </div>
</div>
...
<div class="col-lg-9 col-lg-pull-3 col-md-12">
  <div class="alert alert-info">
    <?php echo $text_ads_intro; ?>
  </div>
  <hr/>
  <div class="row">
    <div class="col-md-12">
      <div class="pull-right form-control-static">
        <button type="button" class="btn btn-default button-popup-bulk-edit form-control-static"><i class="fa fa-cog"></i> <?php echo $button_bulk_edit_google_fields; ?></button>
        <div class="btn-group form-control-static">
          <button type="button" class="btn btn-default dropdown-toggle button-advertise" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $button_select_campaigns; ?> <span class="caret"></span></button>
          <ul class="dropdown-menu dropdown-menu-right campaign-dropdown">
            <?php foreach ($campaigns as $campaign) { ?>
            <li class="text-pre-line"><a><input type="checkbox" name="target_ids[]" value="<?php echo $campaign['target_id']; ?>"/>&nbsp;&nbsp;<span class="form-control-static"><?php echo $campaign['campaign_name']; ?></span></a></li>
            <?php } ?>
            <li role="separator" class="divider"></li>
            <li class="text-center padding-lr-5">
              <p class="text-left text-sm text-pre-line"><em><?php echo $text_maximum_five; ?></em></p>
              <button class="btn btn-success btn-xs button-apply-advertising"><i class="fa fa-check"></i> <?php echo $button_apply; ?></button>
            </li>
          </ul>
        </div>
      </div>
    ...
    <table class="table table-bordered table-hover">
      <thead id="list-head">
        <tr>
          ...
          <th class="text-left visible-lg"><a href="javascript:void(0)" data-sort="name"><?php echo $text_product_name; ?></a></th>
          <th class="text-left"><a href="javascript:void(0)" data-sort="model"><?php echo $text_product_model; ?></a></th>
          <th class="text-center"><a href="javascript:void(0)" data-sort="impressions"><i data-toggle="tooltip" data-original-title="<?php echo $text_impressions; ?>" class="fa fa-eye"></i></a></th>
          <th class="text-center"><a href="javascript:void(0)" data-sort="clicks"><i data-toggle="tooltip" data-original-title="<?php echo $text_clicks; ?>" class="fa fa-hand-pointer-o"></i></a></th>
          <th class="text-center"><a href="javascript:void(0)" data-sort="cost"><i data-toggle="tooltip" data-original-title="<?php echo $text_cost; ?>" class="fa fa-dollar"></i></a></th>
          <th class="text-center"><a href="javascript:void(0)" data-sort="conversions"><i data-toggle="tooltip" data-original-title="<?php echo $text_conversions; ?>" class="fa fa-trophy"></i></a></th>
          <th class="text-center"><a href="javascript:void(0)" data-sort="conversion_value"><i data-toggle="tooltip" data-original-title="<?php echo $text_conversion_value; ?>" class="fa fa-line-chart"></i></a></th>
          </a></th>
          <th class="text-left"><?php echo $text_campaigns; ?></th>
          <th class="text-center"><a href="javascript:void(0)" data-sort="destination_status"><?php echo $text_destination_status; ?></a></th>
          <th class="text-center"><a href="javascript:void(0)" data-sort="has_issues"><?php echo $text_issues; ?></a></th>
      ...
      <div class="pull-right form-control-static">
        ...
        <div class="btn-group dropup form-control-static">
          ...
          <ul class="dropdown-menu dropdown-menu-right campaign-dropdown">
            ...
            <li class="text-center padding-lr-5">
              <p class="text-left text-sm text-pre-line"><em><?php echo $text_maximum_five; ?></em></p>
              <button class="btn btn-success btn-sm button-apply-advertising"><i class="fa fa-check"></i> <?php echo $button_apply; ?></button>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="<?php echo $text_close; ?>"><span aria-hidden="true"><i class="fa fa-close"></i></span></button>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="button-popup-product-save"><?php echo $button_save; ?></button>
      </div>
    </div>
  </div>
</div>
...
(function($) {
    ...
    var makeDestinationStatus = function(status) {
        switch (status) {
            case 'pending' :
                return '<span class="label label-warning"><?php echo $text_label_pending; ?></span>';
            case 'approved' :
                return '<span class="label label-success"><?php echo $text_label_approved; ?></span>';
            case 'disapproved' :
                return '<span class="label label-danger"><?php echo $text_label_disapproved; ?></span>';
        }
    }

    var makeIssuesButton = function(has_issues, url) {
        if (has_issues) {
            return '<a data-toggle="tooltip" title="<?php echo $text_view_issues; ?>" class="btn btn-warning" data-url-popup-issues="' + url + '"><i class="fa fa-exclamation-triangle"></i></a>';
        }
    ...
    var makeCampaigns = function(campaigns) {
        ...
        return html != '' ? html : '<span class="label label-default"><?php echo $text_label_unassigned; ?></span>';
    }
    ...
    var listProducts = function() {
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $(selector.list).html('<tr><td colspan="' + $(selector.head).find('th').length + '"><div class="text-center"><?php echo $text_loading; ?></div></td></tr>');
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                if ($(selector.ad_wrap).height() == 0) {
                  $(selector.list).html('<tr><td colspan="' + $(selector.head).find('th').length + '"><div class="alert alert-danger"><?php echo $error_adblock; ?></div></td></tr>');
                } else {
                ...
                if (typeof data.error != 'undefined') {
                    ...
                    if (data.products.length) {
                        $(data.products).each(function(index, product) {
                            ...
                            html += '<td class="highlightable text-right"><button class="btn ' + (product.is_modified ? "btn-default" : "btn-warning") + '" data-toggle="tooltip" title="' + (product.is_modified ? "<?php echo $button_product_edit; ?>" : "<?php echo $button_product_set; ?>") + '" data-product-id="' + product.product_id + '" data-product-advertise-google-id="' + product.product_advertise_google_id + '"><i class="fa fa-cog"></i></button></td>';
                        ...
                        $(selector.list).html('<tr><td colspan="' + $(selector.head).find('th').length + '"><div class="text-center"><?php echo $text_no_results; ?></div></td></tr>');
                    }
    ...
    var updateSelected = function() {
        ...
        var selection_text = '<?php echo $text_selection_page; ?>'.replace(/{selected_page}/, selected).replace(/{total}/, total_items);
        var deselection_text = '<?php echo $text_selection_all; ?>'.replace(/{total}/, total_items);
    ...
    var googleFieldsPopup = function(settings) {
        var data = {
            title: '<?php echo $text_popup_loading_title; ?>',
            body: '<p><?php echo $text_popup_loading_body; ?><p>'
        };
        ...
        var ajaxError = function(jqXHR, textStatus, errorThrown) {
            var new_html = getPopupHtml(selector.popup.product.template, {
                title: '<?php echo $text_popup_error_title; ?>',
                body: '<?php echo $text_popup_error_body; ?>'.replace(/{error}/g, errorThrown)
            });
