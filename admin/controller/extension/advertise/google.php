...
class ControllerExtensionAdvertiseGoogle extends Controller {
    ...
    public function index() {
        $data = $this->load->language('extension/advertise/google');
        ...
        if (!$this->setting->get('advertise_google_checklist_confirmed')) {
            $this->response->redirect($this->url->link('extension/advertise/google/checklist', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true));
        }

        try {
            // If we have not connected, navigate to connect screen
            if (!$this->setting->has('advertise_google_access_token')) {
                $this->response->redirect($this->url->link('extension/advertise/google/connect', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true));
                ...
                $this->response->redirect($this->url->link('extension/advertise/google/merchant', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true));
                ...
                $this->response->redirect($this->url->link('extension/advertise/google/campaign', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true));
                ...
                $this->response->redirect($this->url->link('extension/advertise/google/shipping_taxes', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true));
                ...
                $this->response->redirect($this->url->link('extension/advertise/google/mapping', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true));
            }
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateSettings()) {
            ...
            try {
                ...
                $this->response->redirect($this->url->link('extension/advertise/google', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true));
            } catch (ConnectionException $e) {
                $this->session->data['error'] = $e->getMessage();
        ...
        if (!$this->setting->get('advertise_google_status') && $this->model_extension_advertise_google->hasActiveTarget($this->store_id)) {
            ...
            $data['warning'] = sprintf($this->language->get('warning_no_active_campaigns'), $this->url->link('extension/advertise/google/campaign', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true));
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=advertise', true),
        );
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('extension/advertise/google', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true),
        );
        ...
        $data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=advertise', true);
        $data['action'] = $this->url->link('extension/advertise/google', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
        $data['shipping_taxes'] = $this->url->link('extension/advertise/google/shipping_taxes', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true);
        $data['campaign'] = $this->url->link('extension/advertise/google/campaign', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true);
        $data['mapping'] = $this->url->link('extension/advertise/google/mapping', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true);
        $data['disconnect'] = $this->url->link('extension/advertise/google/disconnect', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
        $data['list_ads'] = html_entity_decode($this->url->link('extension/advertise/google/list_ads', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        $data['advertise'] = html_entity_decode($this->url->link('extension/advertise/google/advertise', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        $data['url_popup'] = html_entity_decode($this->url->link('extension/advertise/google/popup_product', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        $data['url_category_autocomplete'] = html_entity_decode($this->url->link('extension/advertise/google/category_autocomplete', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        $data['url_debug_log_download'] = html_entity_decode($this->url->link('extension/advertise/google/debug_log_download', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
    ...
    public function advertise() {
        ...
        if (!$this->setting->get('advertise_google_status') && $this->model_extension_advertise_google->hasActiveTarget($this->store_id)) {
            ...
            $json['warning'] = sprintf($this->language->get('warning_no_active_campaigns'), $this->url->link('extension/advertise/google/campaign', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true));
        } else if ($advertised_count == 0) {
    ...
    public function merchant() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validatePermission()) {
            try {
                $redirect_uri = html_entity_decode($this->url->link('extension/advertise/google/callback_merchant', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('extension/advertise/google/merchant', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true),
        );

        $data['cancel']       = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=advertise', true);
        $data['action']       = $this->url->link('extension/advertise/google/merchant', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
    ...
    public function shipping_taxes() {
        ...
        if ($data['from_dashboard']) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/advertise/google/shipping_taxes', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true),
            );
        }

        if ($data['from_dashboard']) {
            $data['cancel']       = $this->url->link('extension/advertise/google', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
        } else {
            $data['cancel']       = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=advertise', true);
        }

        $data['action']       = $this->url->link('extension/advertise/google/shipping_taxes', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
    ...
    public function mapping() {
        ...
        if ($data['from_dashboard']) {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_shipping_taxes'),
                'href' => $this->url->link('extension/advertise/google/mapping', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true),
            );
        }
        ...
        $data['action']       = $this->url->link('extension/advertise/google/mapping', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);

        $data['token'] = $this->session->data['token'];

        $data['url_mapping_verify'] = html_entity_decode($this->url->link('extension/advertise/google/mapping_verify', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        $data['url_category_autocomplete'] = html_entity_decode($this->url->link('extension/advertise/google/category_autocomplete', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
    ...
    public function campaign_test() {
        ...
        if ($this->validatePermission()) {
            try {
                ...
                $json['redirect'] = html_entity_decode($this->url->link('extension/advertise/google/connect', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
            } catch (\RuntimeException $e) {
                $json['status'] = false;
    ...
    public function campaign() {
        ...
        if ($data['from_dashboard']) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/advertise/google/campaign', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&from_dashboard=true', true),
            );
        }
        ...
        $data['action'] = $this->url->link('extension/advertise/google/campaign', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
        $data['target_add'] = html_entity_decode($this->url->link('extension/advertise/google/target_add', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        $data['target_edit'] = html_entity_decode($this->url->link('extension/advertise/google/target_edit', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&advertise_google_target_id={target_id}', true), ENT_QUOTES, 'UTF-8');
        $data['target_delete'] = html_entity_decode($this->url->link('extension/advertise/google/target_delete', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&advertise_google_target_id={target_id}', true), ENT_QUOTES, 'UTF-8');
        $data['target_list'] = html_entity_decode($this->url->link('extension/advertise/google/target_list', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        $data['url_campaign_test'] = html_entity_decode($this->url->link('extension/advertise/google/campaign_test', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
    ...
    public function connect() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateSettings() && $this->validateConnect()) {
            ...
            $this->session->data['advertise_google']['redirect_uri'] = html_entity_decode($this->url->link('extension/advertise/google/callback_connect', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true), ENT_QUOTES, 'UTF-8');
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('extension/advertise/google/connect', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true),
        );
        ...
        $data['cancel']       = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=advertise', true);
        $data['action']       = $this->url->link('extension/advertise/google/connect', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
    ...
    public function checklist() {
        ...
        $data['cancel']       = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=advertise', true);
        $data['action']       = $this->url->link('extension/advertise/google/checklist', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'], true);
    ...
    public function popup_product() {
        ...
        $data = $this->language->load('extension/advertise/google');
        ...
        foreach ($data['menus'] as &$menu) {
            if ($menu['id'] == 'menu-marketing') {
                ...
                $children[] = array(
                    ...
                    'children' => array(),
                    'href' => $this->url->link('extension/advertise/google', 'store_id=0&token=' . $this->session->data['token'], true)
                );
                ...
                foreach ($this->model_setting_store->getStores() as $store) {
                    $children[] = array(
                        'name' => $store['name'],
                        'children' => array(),
                        'href' => $this->url->link('extension/advertise/google', 'store_id=' . $store['store_id'] . '&token=' . $this->session->data['token'], true)
                    );
                }
    ...
    public function uninstall() {
        ...
        $this->model_setting_setting->deleteSetting("advertise_google");

        foreach ($this->model_setting_store->getStores() as $store) {
            $this->model_setting_setting->deleteSetting("advertise_google", $store['store_id']);
        }
    }
    ...
    protected function product(&$row) {        
        ...
        return array(
            ...
            'url_issues' => html_entity_decode($this->url->link('extension/advertise/google/popup_issues', 'store_id=' . $this->store_id . '&token=' . $this->session->data['token'] . '&product_id=' . $row['product_id'], true), ENT_QUOTES, 'UTF-8'),
