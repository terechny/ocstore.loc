...
class ControllerExtensionFeedRestApi extends Controller {
	...
	public function index() {
		...
		$data = array(
			...
			'action'              => $this->url->link('extension/feed/rest_api', 'token=' . $this->session->data['token'], 'SSL'),
		...
		$data['breadcrumbs'][] = array(
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/feed/rest_api', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
   		);
