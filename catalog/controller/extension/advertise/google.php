...
class ControllerExtensionAdvertiseGoogle extends Controller {
    ...
    public function before_checkout_success(&$route, &$data) {
        ...
        foreach ($order_products as &$order_product) {
            $order_product['option'] = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_option WHERE order_id = '" . (int)$order_info['order_id'] . "' AND order_product_id = '" . (int)$order_product['order_product_id'] . "'")->rows;
        }
